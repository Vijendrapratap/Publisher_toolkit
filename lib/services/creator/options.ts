...
export const BOOK_TYPES: BookTypeDefinition[] = [
  {
    ...
    badge: 'Children Story',
    description: 'Create heartwarming picture books with page-by-page storytelling, rhyming or prose, and AI illustration.',
    tags: ['Picture Book', 'Bedtime Stories', 'Illustrations', 'Spread Layout'],
    defaultPages: 8,
    icon: 'baby',
  },
  {
    ...
    tags: ['Coloring Sheets', 'Bold Outlines', 'Printable Line Art', 'KDP Ready'],
    defaultPages: 10,
    icon: 'palette',
  },
  {
    key: 'short_story',
    title: 'Story Book',
    subtitle: 'Compelling narrative chapters & scenes',
    badge: 'Story Book',
    description: 'Generate rich, atmospheric story books with deep characters, dialogue pacing, and scene illustrations.',
    tags: ['Story Book', 'Illustrated Story', 'Fast Turnaround'],
    defaultPages: 4,
    icon: 'feather',
  },
  {
    key: 'word_game',
    title: 'Games & Puzzle Book',
    subtitle: 'Word searches, crosswords & puzzles',
    badge: 'Activity & Games',
    description: 'Create playable word searches with real letter grids, crossword clues & solutions, and themed activity artwork.',
    tags: ['Word Search Grid', 'Crosswords', 'Answer Keys', 'Activity Games'],
    defaultPages: 6,
    icon: 'puzzle',
  },
]
...
export const INSPIRATION_TEMPLATES = [
  ...
  {
    bookType: 'short_story' as BookTypeKey,
    title: 'The Whispering Tree of Silver Glen',
    concept: 'An enchanting tale of two siblings who discover an ancient silver oak in the hidden woods that only reveals its magic when someone tells it a true story of courage.',
    styleTheme: 'literary_atmospheric',
    targetAudience: 'middle_grade',
  },
  {
    bookType: 'coloring' as BookTypeKey,
...
}).refine((v) => v.bookType !== 'novel_chapter', {
  // Kept in the enum only so existing novel projects still load.
  message: 'Novels are no longer supported. Choose a children, coloring, story or games book.',
  path: ['bookType'],
})
